...
## to hash passwords and store hashes intead of plaintext passwords: relatively SLOW

# output of hash function: hash, or digest

# good hash function like SHA256 gives a totally unique output
# can use as id aka fingerprint of a document (document == big string)

# Can not reverse a hash
